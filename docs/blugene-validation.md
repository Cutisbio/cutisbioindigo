...
**이미 실린 49건은 건드리지 않았다.** 새 규칙은 앞으로 수집되는 기사에 적용된다.
기존 기사 중 새 규칙에 맞지 않는 것을 정리할지는 별도 판단이 필요하다.

> 확인된 제약: 자동 수집 기사의 요약은 Google News RSS 가 본문 대신
> "제목 + 매체명" 을 주기 때문에 제목과 거의 같다(49건 중 45건). 스크립트로 고칠 수 없다.
